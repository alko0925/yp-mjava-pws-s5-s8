...
import ru.yp.sprint5pw.service.TransactionTemplateService;
...
class TransactionTemplateServiceTest extends MyMarketApplicationTest {
    ...
    void testTransactionManager() {
        ...
        Assertions.assertThrows(
                ...
                () -> transactionTemplateService.transfer(vasily, petr, BigDecimal.valueOf(100_000L))
        );
