...
import ru.yp.sprint5pw.service.TransactionalAnnotationService;
...
class TransactionalAnnotationServiceTest extends MyMarketApplicationTest {

    @Autowired
    TransactionalAnnotationService transactionalAnnotationService;
    ...
    void testTransactionManager() {
        ...
        Assertions.assertThrows(
                ...
                () -> transactionalAnnotationService.transfer(vasily, petr, BigDecimal.valueOf(100_000L))
        );
